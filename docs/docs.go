...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/accountant.GetOperatorResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/accountant.ErrorResponse"
                        }
                    }
                }
            }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/accountant.ResultById"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "accountant.GetOperatorResponse": {
            "type": "object",
            "properties": {
                "has_next": {
                    "type": "boolean"
                ...
                "operators": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/accountant.Operator"
                    }
                },
                "page": {
                    "type": "integer"
